...
def quick(
    ...
    async def _quick() -> None:
        ...
        # Assuming hafs.agents is available.
        from hafs.agents.knowledge.alttp_knowledge import ALTTPKnowledgeBase
...
def enhance(
    ...
    async def _enhance() -> None:
        from hafs.agents.knowledge.alttp_embeddings import ALTTPEmbeddingBuilder
        from hafs.agents.knowledge.alttp_knowledge import ALTTPKnowledgeBase
