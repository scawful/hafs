...
Usage:
    # Run directly
    python -m services.embedding_daemon

    # With options
    python -m services.embedding_daemon --batch-size 50 --interval 30

    # Install as launchd service
    python -m services.embedding_daemon --install

    # Check status
    python -m services.embedding_daemon --status
"""
...
<dict>
    ...
    <array>
        ...
        <string>-m</string>
        <string>services.embedding_daemon</string>
