...
from tui.widgets.synergy_panel import SynergyPanel
...
class OrchestratorScreen(WhichKeyMixin, VimNavigationMixin, Screen):
    ...
    def _apply_fears_to_state(self, message: str) -> None:
        ...
        try:
            from core.protocol.state_md import update_risk_block
        ...
        if self._coordinator:
            ...
            if target:
                ...
                if lane_widget:
                    ...
                    try:
                        from tui.widgets.terminal_emulator import TerminalDisplay
