...
class ScreenRouter:
    ...
    def _emit_navigation_event(
        ...
        from tui.core.event_bus import NavigationEvent, get_event_bus
...
def register_default_routes(router: ScreenRouter, use_modular: bool = True) -> None:
    ...
    if use_modular:
        ...
        from tui.screens.workspace import SessionWorkspace
    ...
    if use_modular:
        from tui.screens.analysis_screen import AnalysisDashboardScreen
